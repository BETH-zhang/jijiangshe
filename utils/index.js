...
exports.getHtmlTemplate = (function() {
  function docTypeHtml(title, contentHtml, style) {
    const html = [];
    html.push('<!DOCTYPE html>');
    html.push('<html lang="zh">');
    html.push('<head>');
  ...
  return function(title, contentHtml, style) {
     return docTypeHtml(title, contentHtml, style);
  }
})();

exports.createFolder = function (to) {
	const sep = path.sep
